...
type AjaxDisasterStartReadController struct {
	controllers.BaseController
}

func (this *AjaxDisasterStartReadController) Post() {
	//权限检测
...
type AjaxDisasterStopReadController struct {
	controllers.BaseController
}

func (this *AjaxDisasterStopReadController) Post() {
	//权限检测
	// if !strings.Contains(this.GetSession("userPermission").(string), "oper-switch-view") {
	// 	this.Abort("401")
	// }
