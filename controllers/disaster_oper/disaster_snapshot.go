...
//业务系统管理
type ManageDisasterSnapshotController struct {
	controllers.BaseController
}

func (this *ManageDisasterSnapshotController) Get() {
	//权限检测
	...
	this.TplName = "disaster_oper/snapshot-index.tpl"
}

type AjaxDisasterStartSnapshotController struct {
	controllers.BaseController
}

func (this *AjaxDisasterStartSnapshotController) Post() {
	//权限检测
...
type AjaxDisasterStopSnapshotController struct {
	controllers.BaseController
}

func (this *AjaxDisasterStopSnapshotController) Post() {
	//权限检测
	// if !strings.Contains(this.GetSession("userPermission").(string), "oper-switch-view") {
	// 	this.Abort("401")
	// }
