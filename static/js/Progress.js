var Progress = function () {
  var progress = {
    ...
    render: function (context, length, r, i, percent) {
      ...
      gradient.addColorStop('0', '#2e49ca')
      gradient.addColorStop('1.0', '#18104d')
    ...
    //   context.arc(length / 2, r, 0.6 * r, 0, 2 * Math.PI, false)
      ...
      context.closePath()
      context.beginPath()
      context.font = 'bold ' + (length / 2 - 2.5 * r) / 1.7 + 'px 微软雅黑'
      context.fillStyle = '#ffffff'
      var text = percent + '%'
...
var Progress2 = function () {
    var progress = {
      ...
      render: function (context, length, r, i, percent) {
        ...
        context.beginPath()
        var gradient = context.createLinearGradient(length, 0, 0, 0)
        gradient.addColorStop('0', '#390e54')
        gradient.addColorStop('1.0', '#833193')
        context.strokeStyle = gradient
        context.lineWidth = r
        context.arc(
          length / 2,
