            ...
            <div class="panel-body">
              <form class="form-horizontal adminex-form" id="osconfig-form">
                ...
                <div id="div_alarm" class="form-group">
                  ...
                  <div>
                    <input type="checkbox" id="is_alert" value="1" name="is_alert" {{if eq 1 .osconf.Is_Alert}}checked="checked"{{end}}>发送
                  </div>
                </div>
                ...
                <div id="div_alarm_media" class="form-group">
                  ...
                  <div>
                    <input type="checkbox" id="alert_mail" value="1" name="alert_mail" {{if eq 1 .osconf.Alert_Mail}}checked="checked"{{end}}>邮件
                    <input type="checkbox" id="alert_wechat" value="1" name="alert_wechat" {{if eq 1 .osconf.Alert_WeChat}}checked="checked"{{end}}>微信
                    <input type="checkbox" id="alert_sms" value="1" name="alert_sms" {{if eq 1 .osconf.Alert_SMS}}checked="checked"{{end}}>短信
                  </div>
                </div>
                <div class="form-group">
