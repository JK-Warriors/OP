              ...
              <div class="panel">
                <div class="panel-body">
                  <div class="profile-desk">
                    ...
                    <h1>项目<a class="pull-right" style="font-size:16px;"></a></h1>
              ...
              <div class="panel">
                <div class="panel-body">
                  <div class="profile-desk">
                    ...
                    <h1>任务<a class="pull-right" style="font-size:16px;" ></a></h1>
                    <table class="table table-bordered table-striped table-condensed cf">
                      <thead class="cf">
                        <tr>
                          <th>任务名称</th>
              ...
              <div class="panel">
                <div class="panel-body">
                  <div class="profile-desk">
                    ...
                    <h1>Bug<a class="pull-right" style="font-size:16px;" ></a></h1>
                    <table class="table table-bordered table-striped table-condensed cf">
                      <thead class="cf">
                        <tr>
                          <th>Bug标题</th>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel">
                ...
                <header class="panel-heading"> 知识</header>
                <div class="panel-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel">
                ...
                <header class="panel-heading"> 相册  </header>
