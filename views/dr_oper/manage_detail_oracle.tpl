...
<section>
  ...
  <div class="main-content">
	...
	<div class="pull-right">
		<button name="startread" class="btn btn-primary" type="button" value="StartRead" onclick="checkUser(this)" data-id="{{.dr_id}}"> <i class="fa fa-reset"></i> 开启可读 </button>
		<button name="stopread" class="btn btn-danger" type="button" value="StopRead" onclick="checkUser(this)" data-id="{{.dr_id}}"> <i class="fa fa-reset"></i> 停止可读 </button>
		<button name="startsync" class="btn btn-primary" type="button" value="StartSync" onclick="checkUser(this)" data-id="{{.dr_id}}"> <i class="fa fa-reset"></i> 启动同步 </button>
		<button name="stopsync" class="btn btn-danger" type="button" value="StopSync" onclick="checkUser(this)" data-id="{{.dr_id}}"> <i class="fa fa-reset"></i> 停止同步 </button>
