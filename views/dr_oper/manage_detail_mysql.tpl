...
<section>
  ...
  <div class="main-content">
	...
	<div style="padding: 19px; " >
		<div style='padding: 20px 120px 0px 60px; height:180px; overflow:hidden'>
			...
			<div><label name="pri_version" class="control-label" for="">数据库版本：{{ .pri_config.Version }}</label></div>
			<div><label name="pri_binlog_file" class="control-label" for="">Binlog日志：{{ .pri_dr.M_Binlog_File }}</label></div>
			<div><label name="pri_binlog_pos" class="control-label" for="">Binlog位置：{{ .pri_dr.M_Binlog_Pos }}</label></div>
			<div><label name="pri_binlog_space" class="control-label" for="">Binlog空间：{{ .pri_dr.M_Binlog_Space }}</label></div>
			</div>
			...
			<div><label name="sta_version" class="control-label" for="">数据库版本：{{ .sta_config.Version }}</label></div>
			<div><label name="sta_binlog_file" class="control-label" for="">Binlog日志：{{ .sta_dr.C_Binlog_File }}</label></div>
			<div><label name="sta_binlog_pos" class="control-label" for="">Binlog位置：{{ .sta_dr.C_Binlog_Pos }}</label></div>
			<div><label name="sta_delay" class="control-label" for="">延时：{{ .sta_dr.Delay }}</label></div>
			</div>
		</div>
	</div>
	...
	<div style='padding: 5px 0px 0px 200px; height:150px;'>
		<div style="float:left;"><img {{if eq -1 .pri_config.Connect }}src="/static/img/connect_error.png"{{else}}src="/static/img/primary_db.png"{{end}} /></div> 
			...
			<div><label style='padding: 0px 0px 0px 120px;' class="control-label" for="">文件：{{ .sta_dr.C_Binlog_File }}</label></div>
